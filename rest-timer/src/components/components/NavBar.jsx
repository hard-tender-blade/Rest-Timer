    ...
    <div className="w-screen bg-white">
      <div className="max-w-screen-2xl m-auto h-20 flex justify-around text-base text-grey-t font-intertight">
        <div className="w-24 m-auto text-center">
          <button
            className={`${
              currentPage === Pages.Home
                ? "font-inter font-medium text-text-b"
                : ""
            } hover:text-dark-b transition-colors duration-200 ease-in-out`}
            onClick={() => {
          ...
          <div
            className={`rounded w-18 h-1 bg-dark-b ${
              currentPage === Pages.Home ? "" : "invisible"
            }`}
          />
        </div>
        <div className="w-24 m-auto text-center">
          ...
          <div
            className={`rounded w-18 h-1 bg-dark-b ${
              currentPage === Pages.Medals ? "" : "invisible"
            }`}
          />
        </div>
        <div className="w-24 m-auto text-center">
          ...
          <div
            className={`rounded w-18 h-1 bg-dark-b ${
              currentPage === Pages.HealthInfo ? "" : "invisible"
            }`}
          />
        </div>
        <div className="w-24 m-auto text-center">
          ...
          <div
            className={`rounded w-18 h-1 bg-dark-b ${
              currentPage === Pages.Profile ? "" : "invisible"
            }`}
          />
        </div>
        ...
        <div className="w-24 m-auto text-center">
          ...
          <div
            className={`rounded w-18 h-1 bg-dark-b ${
              currentPage === Pages.About ? "" : "invisible"
            }`}
          />
        </div>
      </div>
